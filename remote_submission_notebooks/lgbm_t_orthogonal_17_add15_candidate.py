"""Orthogonal T LightGBM with 17 factors; add15, screened15 lambda=1."""
...
def main(datasources, start_date, end_date):
    ...
    self_columns = ['HF-044', 'PV-009', 'HF-057', 'PV-029', 'HF-001', 'HF-019', 'PV-034', 'HF-025', 'HF-053', 'FR-005', 'HF-070', 'PV-004', 'HF-067', 'HF-068', 'HF-049', 'HF-024', 'HF-062']
