"""S-route family-balanced composite with 56 factors."""
...
def _candidate_factors(selected, financial, factorlib, exposure, daily_features, pool, pd, np):
    import inspect
    from rule_s_56_candidate_deps import get_candidate_spec
