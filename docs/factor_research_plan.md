...
- 完整族平衡路线通过 J 确认后，其 FR/PV/HF/OB 原子成员进入
...
8. 三条路线先在合并的 2022—2023 上分别比较 `z` 与 `-z` 的 J，冻结 J 更高的
   单一方向；不得同时保留或提交两个方向；
9. 对冻结方向后的三条路线分别计算 2022 J、2023 J、两年合并基础 J，并用一次
...
- 2022、2023、两年合并基础场景和兄弟路线拥挤场景的 J；
- 正负方向的 J 及最终冻结方向；
