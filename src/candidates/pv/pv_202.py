r"""PV-202: report-derived candidate, source HAITONG-0022.

Source research ID: HAITONG-0022
Frozen formula: mean_10d(log(high/open))
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "HAITONG-0022"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0022"
ORIENTATION = 1.0
...
def build_pv_202_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_202_daily(daily_features)
    result = panel.merge(
        daily,
