r"""PV-204: report-derived candidate, source HAITONG-0024.

Source research ID: HAITONG-0024
Frozen formula: mean_10d(log(close/low))
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "HAITONG-0024"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0024"
ORIENTATION = 1.0
...
def build_pv_204_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_204_daily(daily_features)
    result = panel.merge(
        daily,
