r"""PV-209: report-derived candidate, source HAITONG-0037.

Source research ID: HAITONG-0037
Frozen formula: (HAITONG-0027)^2
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "HAITONG-0037"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0037"
ORIENTATION = 1.0
...
def build_pv_209_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_209_daily(daily_features)
    result = panel.merge(
        daily,
