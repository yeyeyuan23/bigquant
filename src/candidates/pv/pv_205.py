r"""PV-205: report-derived candidate, source HAITONG-0025.

Source research ID: HAITONG-0025
Frozen formula: mean_20d(log(close/low))
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "HAITONG-0025"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0025"
ORIENTATION = 1.0
...
def build_pv_205_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_205_daily(daily_features)
    result = panel.merge(
        daily,
