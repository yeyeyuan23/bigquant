r"""PV-154: report-derived candidate, source GTJA-0126.

Source research ID: GTJA-0126
Frozen formula: (CLOSE+HIGH+LOW)/3
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0126"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0126"
ORIENTATION = 1.0
...
def build_pv_154_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_154_daily(daily_features)
    result = panel.merge(
        daily,
