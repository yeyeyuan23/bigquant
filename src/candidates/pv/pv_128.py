r"""PV-128: report-derived candidate, source GTJA-0100.

Source research ID: GTJA-0100
Frozen formula: STD(VOLUME,20)
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0100"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0100"
ORIENTATION = 1.0
...
def build_pv_128_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_128_daily(daily_features)
    result = panel.merge(
        daily,
