...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0159"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0159"
ORIENTATION = 1.0
...
def build_pv_180_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_180_daily(daily_features)
    result = panel.merge(
        daily,
