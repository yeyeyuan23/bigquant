r"""PV-170: report-derived candidate, source GTJA-0147.

Source research ID: GTJA-0147
Frozen formula: REGBETA(MEAN(CLOSE,12),SEQUENCE(12))
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0147"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0147"
ORIENTATION = 1.0
...
def build_pv_170_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_170_daily(daily_features)
    result = panel.merge(
        daily,
