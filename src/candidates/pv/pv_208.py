r"""PV-208: report-derived candidate, source HAITONG-0036.

Source research ID: HAITONG-0036
Frozen formula: (HAITONG-0026)^2
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "HAITONG-0036"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0036"
ORIENTATION = 1.0
...
def build_pv_208_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_208_daily(daily_features)
    result = panel.merge(
        daily,
