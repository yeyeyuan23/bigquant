r"""PV-173: report-derived candidate, source GTJA-0151.

Source research ID: GTJA-0151
Frozen formula: SMA(CLOSE-DELAY(CLOSE,20),20,1)
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0151"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0151"
ORIENTATION = 1.0
...
def build_pv_173_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_173_daily(daily_features)
    result = panel.merge(
        daily,
