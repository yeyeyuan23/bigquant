"""HF-005: competition-adapted CICC high-frequency candidate.

Source: CICC, High-Frequency Factor Handbook (2024-01-15), CICC-001.
Semantic class: LATENT_COMPONENT; include in J baseline: true.
Data families: HF.
Frozen formula: sum of within-PM session log returns.
Economic logic: Afternoon price discovery and continuation.
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CICC-001"
SOURCE_FIDELITY = "exact"
COMPONENT_COLUMN = "mmt_pm"
ORIENTATION = 1.0
...
def compute_hf_005_daily(daily_features: pd.DataFrame) -> pd.DataFrame:
...
def build_hf_005_factor_from_daily(
    ...
    daily = compute_hf_005_daily(daily_features)
