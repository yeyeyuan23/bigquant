r"""HF-135: report-derived candidate, source CJ-G039-V01.

Source research ID: CJ-G039-V01
Frozen formula: 20d volume volatility-of-volatility method 1, 5m
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G039-V01"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G039-V01"
ORIENTATION = 1.0
...
def build_hf_135_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_135_daily(daily_features)
    result = panel.merge(
        daily,
