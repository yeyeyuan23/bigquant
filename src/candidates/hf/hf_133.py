r"""HF-133: report-derived candidate, source CJ-G034-V01.

Source research ID: CJ-G034-V01
Frozen formula: volume-weighted price skewness
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G034-V01"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G034-V01"
ORIENTATION = 1.0
...
def build_hf_133_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_133_daily(daily_features)
    result = panel.merge(
        daily,
