r"""HF-131: report-derived candidate, source CJ-G032-V01.

Source research ID: CJ-G032-V01
Frozen formula: corr_1m(volume, close)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G032-V01"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G032-V01"
ORIENTATION = 1.0
...
def build_hf_131_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_131_daily(daily_features)
    result = panel.merge(
        daily,
