r"""HF-137: report-derived candidate, source CJ-G039-V03.

Source research ID: CJ-G039-V03
Frozen formula: 20d volume volatility-of-volatility method 3, 5m
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G039-V03"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G039-V03"
ORIENTATION = 1.0
...
def build_hf_137_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_137_daily(daily_features)
    result = panel.merge(
        daily,
