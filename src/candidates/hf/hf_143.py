r"""HF-143: report-derived candidate, source CJ-G039-V09.

Source research ID: CJ-G039-V09
Frozen formula: 20d amp volatility-of-volatility method 1, 5m
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G039-V09"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G039-V09"
ORIENTATION = 1.0
...
def build_hf_143_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_143_daily(daily_features)
    result = panel.merge(
        daily,
