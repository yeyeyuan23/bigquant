r"""HF-218: report-derived candidate, source CJ-G104-V04.

Source research ID: CJ-G104-V04
Frozen formula: mean_21d(high-density pvol)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G104-V04"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G104-V04"
ORIENTATION = 1.0
...
def build_hf_218_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_218_daily(daily_features)
    result = panel.merge(
        daily,
