r"""HF-100: report-derived candidate, source HAITONG-0072.

Source research ID: HAITONG-0072
Frozen formula: mean_20d(m1_up_ratio)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "HAITONG-0072"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0072"
ORIENTATION = 1.0
...
def build_hf_100_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_100_daily(daily_features)
    result = panel.merge(
        daily,
