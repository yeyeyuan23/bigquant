r"""HF-147: report-derived candidate, source CJ-G039-V15.

Source research ID: CJ-G039-V15
Frozen formula: 20d amp volatility-of-volatility method 4, 1m
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G039-V15"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G039-V15"
ORIENTATION = 1.0
...
def build_hf_147_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_147_daily(daily_features)
    result = panel.merge(
        daily,
