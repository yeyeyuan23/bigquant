r"""HF-097: report-derived candidate, source HAITONG-0048.

Source research ID: HAITONG-0048
Frozen formula: mean_20d(m1_kurt_origin)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "HAITONG-0048"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0048"
ORIENTATION = 1.0
...
def build_hf_097_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_097_daily(daily_features)
    result = panel.merge(
        daily,
