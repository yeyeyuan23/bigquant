r"""HF-217: report-derived candidate, source CJ-G104-V03.

Source research ID: CJ-G104-V03
Frozen formula: mean_21d(high-volume pvol)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G104-V03"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G104-V03"
ORIENTATION = 1.0
...
def build_hf_217_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_217_daily(daily_features)
    result = panel.merge(
        daily,
