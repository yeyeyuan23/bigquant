r"""HF-139: report-derived candidate, source CJ-G039-V05.

Source research ID: CJ-G039-V05
Frozen formula: 20d deal volatility-of-volatility method 1, 5m
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G039-V05"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G039-V05"
ORIENTATION = 1.0
...
def build_hf_139_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_139_daily(daily_features)
    result = panel.merge(
        daily,
