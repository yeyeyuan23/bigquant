r"""PV-192: report-derived candidate, source GTJA-0177.

Source research ID: GTJA-0177
Frozen formula: ((20-HIGHDAY(HIGH,20))/20)*100
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0177"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0177"
ORIENTATION = 1.0
...
def build_pv_192_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_192_daily(daily_features)
    result = panel.merge(
        daily,
