r"""PV-206: report-derived candidate, source HAITONG-0026.

Source research ID: HAITONG-0026
Frozen formula: mean_10d(log(vwap/close))
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "HAITONG-0026"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0026"
ORIENTATION = 1.0
...
def build_pv_206_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_206_daily(daily_features)
    result = panel.merge(
        daily,
