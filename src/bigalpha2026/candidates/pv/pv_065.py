r"""PV-065: report-derived candidate, source GTJA-0024.

Source research ID: GTJA-0024
Frozen formula: SMA(CLOSE-DELAY(CLOSE,5),5,1)
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0024"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0024"
ORIENTATION = 1.0
...
def build_pv_065_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_065_daily(daily_features)
    result = panel.merge(
        daily,
