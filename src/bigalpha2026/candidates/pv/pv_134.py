r"""PV-134: report-derived candidate, source GTJA-0106.

Source research ID: GTJA-0106
Frozen formula: CLOSE-DELAY(CLOSE,20)
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0106"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0106"
ORIENTATION = 1.0
...
def build_pv_134_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_134_daily(daily_features)
    result = panel.merge(
        daily,
