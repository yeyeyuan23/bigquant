r"""PV-203: report-derived candidate, source HAITONG-0023.

Source research ID: HAITONG-0023
Frozen formula: mean_20d(log(high/open))
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "HAITONG-0023"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0023"
ORIENTATION = 1.0
...
def build_pv_203_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_203_daily(daily_features)
    result = panel.merge(
        daily,
