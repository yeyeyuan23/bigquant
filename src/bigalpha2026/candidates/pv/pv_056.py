r"""PV-056: report-derived candidate, source GTJA-0013.

Source research ID: GTJA-0013
Frozen formula: (((HIGH * LOW)^0.5) - VWAP)
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0013"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0013"
ORIENTATION = 1.0
...
def build_pv_056_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_056_daily(daily_features)
    result = panel.merge(
        daily,
