r"""PV-102: report-derived candidate, source GTJA-0070.

Source research ID: GTJA-0070
Frozen formula: STD(AMOUNT,6)
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0070"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0070"
ORIENTATION = 1.0
...
def build_pv_102_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_102_daily(daily_features)
    result = panel.merge(
        daily,
