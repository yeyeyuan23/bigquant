r"""PV-217: report-derived candidate, source CJ-G020-V03.

Source research ID: CJ-G020-V03
Frozen formula: std_21d(daily return)
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "CJ-G020-V03"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G020-V03"
ORIENTATION = 1.0
...
def build_pv_217_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_217_daily(daily_features)
    result = panel.merge(
        daily,
