r"""PV-062: report-derived candidate, source GTJA-0021.

Source research ID: GTJA-0021
Frozen formula: REGBETA(MEAN(CLOSE,6),SEQUENCE(6))
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0021"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0021"
ORIENTATION = 1.0
...
def build_pv_062_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_062_daily(daily_features)
    result = panel.merge(
        daily,
