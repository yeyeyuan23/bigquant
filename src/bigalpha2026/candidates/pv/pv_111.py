r"""PV-111: report-derived candidate, source GTJA-0081.

Source research ID: GTJA-0081
Frozen formula: SMA(VOLUME,21,2)
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0081"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0081"
ORIENTATION = 1.0
...
def build_pv_111_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_111_daily(daily_features)
    result = panel.merge(
        daily,
