r"""PV-057: report-derived candidate, source GTJA-0014.

Source research ID: GTJA-0014
Frozen formula: CLOSE-DELAY(CLOSE,5)
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0014"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0014"
ORIENTATION = 1.0
...
def build_pv_057_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_057_daily(daily_features)
    result = panel.merge(
        daily,
