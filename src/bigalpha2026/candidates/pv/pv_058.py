r"""PV-058: report-derived candidate, source GTJA-0015.

Source research ID: GTJA-0015
Frozen formula: OPEN/DELAY(CLOSE,1)-1
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0015"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0015"
ORIENTATION = 1.0
...
def build_pv_058_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_058_daily(daily_features)
    result = panel.merge(
        daily,
