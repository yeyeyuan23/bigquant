r"""PV-060: report-derived candidate, source GTJA-0018.

Source research ID: GTJA-0018
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0018"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0018"
ORIENTATION = 1.0
...
def build_pv_060_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_060_daily(daily_features)
    result = panel.merge(
        daily,
