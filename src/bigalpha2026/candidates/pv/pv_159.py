r"""PV-159: report-derived candidate, source GTJA-0132.

Source research ID: GTJA-0132
Frozen formula: MEAN(AMOUNT,20)
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0132"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0132"
ORIENTATION = 1.0
...
def build_pv_159_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_159_daily(daily_features)
    result = panel.merge(
        daily,
