...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "CJ-G112-V01"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G112-V01"
ORIENTATION = 1.0
...
def build_pv_219_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_219_daily(daily_features)
    result = panel.merge(
        daily,
