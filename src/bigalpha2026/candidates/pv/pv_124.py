r"""PV-124: report-derived candidate, source GTJA-0095.

Source research ID: GTJA-0095
Frozen formula: STD(AMOUNT,20)
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0095"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0095"
ORIENTATION = 1.0
...
def build_pv_124_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_124_daily(daily_features)
    result = panel.merge(
        daily,
