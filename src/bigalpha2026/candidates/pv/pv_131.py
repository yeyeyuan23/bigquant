r"""PV-131: report-derived candidate, source GTJA-0103.

Source research ID: GTJA-0103
Frozen formula: ((20-LOWDAY(LOW,20))/20)*100
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0103"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0103"
ORIENTATION = 1.0
...
def build_pv_131_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_131_daily(daily_features)
    result = panel.merge(
        daily,
