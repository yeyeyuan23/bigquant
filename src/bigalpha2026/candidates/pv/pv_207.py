r"""PV-207: report-derived candidate, source HAITONG-0027.

Source research ID: HAITONG-0027
Frozen formula: mean_20d(log(vwap/close))
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "HAITONG-0027"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0027"
ORIENTATION = 1.0
...
def build_pv_207_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_207_daily(daily_features)
    result = panel.merge(
        daily,
