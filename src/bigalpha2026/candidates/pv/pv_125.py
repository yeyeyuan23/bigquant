r"""PV-125: report-derived candidate, source GTJA-0097.

Source research ID: GTJA-0097
Frozen formula: STD(VOLUME,10)
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0097"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0097"
ORIENTATION = 1.0
...
def build_pv_125_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_125_daily(daily_features)
    result = panel.merge(
        daily,
