r"""PV-098: report-derived candidate, source GTJA-0065.

Source research ID: GTJA-0065
Frozen formula: MEAN(CLOSE,6)/CLOSE
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0065"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0065"
ORIENTATION = 1.0
...
def build_pv_098_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_098_daily(daily_features)
    result = panel.merge(
        daily,
