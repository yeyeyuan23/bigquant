r"""PV-144: report-derived candidate, source GTJA-0116.

Source research ID: GTJA-0116
Frozen formula: REGBETA(CLOSE,SEQUENCE,20)
...
DATA_FAMILIES = ("PV",)
SOURCE_RESEARCH_ID = "GTJA-0116"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "GTJA-0116"
ORIENTATION = 1.0
...
def build_pv_144_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_pv_144_daily(daily_features)
    result = panel.merge(
        daily,
