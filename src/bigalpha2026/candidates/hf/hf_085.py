r"""HF-085: report-derived candidate, source CICC-020.

Source research ID: CICC-020
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CICC-020"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CICC-020"
ORIENTATION = 1.0
...
def build_hf_085_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_085_daily(daily_features)
    result = panel.merge(
        daily,
