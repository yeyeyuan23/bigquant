"""HF-010: competition-adapted CICC high-frequency candidate.

Source: CICC, High-Frequency Factor Handbook (2024-01-15), CICC-007.
Semantic class: LATENT_COMPONENT; include in J baseline: true.
Data families: HF.
Frozen formula: mean of squared rolling-50-minute Corr(high, low).
Economic logic: Nonlinear intraday high-low path synchronization.
...
Deduplication: Daily rank correlation 0.99934 with CICC-008; retained as the distinct squared transformation requested in the 34-factor delivery.
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CICC-007"
SOURCE_FIDELITY = "exact"
COMPONENT_COLUMN = "mmt_ols_corr_sqaure_mean"
ORIENTATION = 1.0
...
def compute_hf_010_daily(daily_features: pd.DataFrame) -> pd.DataFrame:
...
def build_hf_010_factor_from_daily(
    ...
    daily = compute_hf_010_daily(daily_features)
