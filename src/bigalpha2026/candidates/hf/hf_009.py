"""HF-009: competition-adapted CICC high-frequency candidate.

Source: CICC, High-Frequency Factor Handbook (2024-01-15), CICC-005.
Semantic class: LATENT_COMPONENT; include in J baseline: true.
Data families: HF.
Frozen formula: sum of log returns after excluding the first and final 30 minutes.
Economic logic: Mid-session directional information.
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CICC-005"
SOURCE_FIDELITY = "exact"
COMPONENT_COLUMN = "mmt_between"
ORIENTATION = 1.0
...
def compute_hf_009_daily(daily_features: pd.DataFrame) -> pd.DataFrame:
...
def build_hf_009_factor_from_daily(
    ...
    daily = compute_hf_009_daily(daily_features)
