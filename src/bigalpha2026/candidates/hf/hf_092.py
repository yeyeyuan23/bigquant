r"""HF-092: report-derived candidate, source HAITONG-0038.

Source research ID: HAITONG-0038
Frozen formula: mean_20d(m1_rv_origin)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "HAITONG-0038"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0038"
ORIENTATION = 1.0
...
def build_hf_092_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_092_daily(daily_features)
    result = panel.merge(
        daily,
