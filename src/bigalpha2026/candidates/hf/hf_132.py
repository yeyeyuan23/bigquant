r"""HF-132: report-derived candidate, source CJ-G033-V01.

Source research ID: CJ-G033-V01
Frozen formula: volume-weighted close / TWAP
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G033-V01"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G033-V01"
ORIENTATION = 1.0
...
def build_hf_132_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_132_daily(daily_features)
    result = panel.merge(
        daily,
