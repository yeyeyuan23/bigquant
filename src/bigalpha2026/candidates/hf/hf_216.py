r"""HF-216: report-derived candidate, source CJ-G104-V02.

Source research ID: CJ-G104-V02
Frozen formula: mean_21d(low-volume pvol)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G104-V02"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G104-V02"
ORIENTATION = 1.0
...
def build_hf_216_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_216_daily(daily_features)
    result = panel.merge(
        daily,
