r"""HF-104: report-derived candidate, source PROJECT-HF-R-013-A.

Source research ID: PROJECT-HF-R-013-A
Frozen formula: (tail_60_signed_volume_bvc/tail_60_volume)*(1-clip(directional_efficiency,0,1))
...
def build_hf_104_factor_from_daily(
    ...
    daily = compute_hf_104_daily(daily_features)
    result = panel.merge(
        daily,
