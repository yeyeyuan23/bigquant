"""HF-007: competition-adapted CICC high-frequency candidate.

Source: CICC, High-Frequency Factor Handbook (2024-01-15), CICC-003.
Semantic class: LATENT_COMPONENT; include in J baseline: true.
Data families: HF.
Frozen formula: PM log return minus AM log return.
Economic logic: Intraday timing asymmetry in price discovery.
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CICC-003"
SOURCE_FIDELITY = "exact"
COMPONENT_COLUMN = "mmt_paratio"
ORIENTATION = 1.0
...
def compute_hf_007_daily(daily_features: pd.DataFrame) -> pd.DataFrame:
...
def build_hf_007_factor_from_daily(
    ...
    daily = compute_hf_007_daily(daily_features)
