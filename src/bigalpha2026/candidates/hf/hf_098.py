r"""HF-098: report-derived candidate, source HAITONG-0050.

Source research ID: HAITONG-0050
Frozen formula: mean_20d(m5_kurt_origin)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "HAITONG-0050"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0050"
ORIENTATION = 1.0
...
def build_hf_098_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_098_daily(daily_features)
    result = panel.merge(
        daily,
