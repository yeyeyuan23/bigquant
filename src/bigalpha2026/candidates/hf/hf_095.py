r"""HF-095: report-derived candidate, source HAITONG-0045.

Source research ID: HAITONG-0045
Frozen formula: mean_20d(m5_skew_origin)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "HAITONG-0045"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0045"
ORIENTATION = 1.0
...
def build_hf_095_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_095_daily(daily_features)
    result = panel.merge(
        daily,
