r"""HF-179: report-derived candidate, source CJ-G060-V01.

Source research ID: CJ-G060-V01
Frozen formula: overall 21d minute vw reversal
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G060-V01"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G060-V01"
ORIENTATION = 1.0
...
def build_hf_179_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_179_daily(daily_features)
    result = panel.merge(
        daily,
