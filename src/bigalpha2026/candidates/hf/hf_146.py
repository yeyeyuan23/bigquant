r"""HF-146: report-derived candidate, source CJ-G039-V12.

Source research ID: CJ-G039-V12
Frozen formula: 20d amp volatility-of-volatility method 4, 5m
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G039-V12"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G039-V12"
ORIENTATION = 1.0
...
def build_hf_146_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_146_daily(daily_features)
    result = panel.merge(
        daily,
