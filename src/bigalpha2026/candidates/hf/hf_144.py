r"""HF-144: report-derived candidate, source CJ-G039-V10.

Source research ID: CJ-G039-V10
Frozen formula: 20d amp volatility-of-volatility method 2, 5m
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G039-V10"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G039-V10"
ORIENTATION = 1.0
...
def build_hf_144_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_144_daily(daily_features)
    result = panel.merge(
        daily,
