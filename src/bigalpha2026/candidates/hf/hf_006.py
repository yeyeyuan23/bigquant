"""HF-006: competition-adapted CICC high-frequency candidate.

Source: CICC, High-Frequency Factor Handbook (2024-01-15), CICC-002.
Semantic class: LATENT_COMPONENT; include in self_library: true.
Data families: HF.
Frozen formula: sum of log returns over the final 30 valid minutes.
Economic logic: Closing directional pressure.
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CICC-002"
SOURCE_FIDELITY = "exact"
COMPONENT_COLUMN = "mmt_last30"
ORIENTATION = 1.0
...
def compute_hf_006_daily(daily_features: pd.DataFrame) -> pd.DataFrame:
...
def build_hf_006_factor_from_daily(
    ...
    daily = compute_hf_006_daily(daily_features)
