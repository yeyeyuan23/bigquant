r"""HF-148: report-derived candidate, source CJ-G039-V18.

Source research ID: CJ-G039-V18
Frozen formula: 20d amp volatility-of-volatility method 4, 15m
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G039-V18"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G039-V18"
ORIENTATION = 1.0
...
def build_hf_148_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_148_daily(daily_features)
    result = panel.merge(
        daily,
