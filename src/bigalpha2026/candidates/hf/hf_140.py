r"""HF-140: report-derived candidate, source CJ-G039-V06.

Source research ID: CJ-G039-V06
Frozen formula: 20d deal volatility-of-volatility method 2, 5m
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G039-V06"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G039-V06"
ORIENTATION = 1.0
...
def build_hf_140_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_140_daily(daily_features)
    result = panel.merge(
        daily,
