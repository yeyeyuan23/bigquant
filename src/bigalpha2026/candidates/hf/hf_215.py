r"""HF-215: report-derived candidate, source CJ-G103-V04.

Source research ID: CJ-G103-V04
Frozen formula: mean_21d((q15-min)/(q5-min))
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G103-V04"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G103-V04"
ORIENTATION = 1.0
...
def build_hf_215_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_215_daily(daily_features)
    result = panel.merge(
        daily,
