"""HF-011: competition-adapted CICC high-frequency candidate.

Source: CICC, High-Frequency Factor Handbook (2024-01-15), CICC-008.
Semantic class: LATENT_COMPONENT; include in J baseline: true.
Data families: HF.
Frozen formula: mean of rolling-50-minute Corr(high, low).
Economic logic: Signed intraday high-low path synchronization.
...
Deduplication: Cluster representative for CICC-007/CICC-008; signed transform preserves interpretation.
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CICC-008"
SOURCE_FIDELITY = "exact"
COMPONENT_COLUMN = "mmt_ols_corr_mean"
ORIENTATION = 1.0
...
def compute_hf_011_daily(daily_features: pd.DataFrame) -> pd.DataFrame:
...
def build_hf_011_factor_from_daily(
    ...
    daily = compute_hf_011_daily(daily_features)
