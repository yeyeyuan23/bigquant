r"""HF-094: report-derived candidate, source HAITONG-0043.

Source research ID: HAITONG-0043
Frozen formula: mean_20d(m1_skew_origin)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "HAITONG-0043"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0043"
ORIENTATION = 1.0
...
def build_hf_094_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_094_daily(daily_features)
    result = panel.merge(
        daily,
