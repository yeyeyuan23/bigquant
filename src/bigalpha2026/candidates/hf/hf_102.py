r"""HF-102: report-derived candidate, source HAITONG-0080.

Source research ID: HAITONG-0080
Frozen formula: mean_20d(m10_up_ratio)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "HAITONG-0080"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0080"
ORIENTATION = 1.0
...
def build_hf_102_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_102_daily(daily_features)
    result = panel.merge(
        daily,
