r"""HF-093: report-derived candidate, source HAITONG-0040.

Source research ID: HAITONG-0040
Frozen formula: mean_20d(m5_rv_origin)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "HAITONG-0040"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0040"
ORIENTATION = 1.0
...
def build_hf_093_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_093_daily(daily_features)
    result = panel.merge(
        daily,
