r"""HF-185: report-derived candidate, source CJ-G065-V02.

Source research ID: CJ-G065-V02
Frozen formula: mean_21d(close-vs-open return)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G065-V02"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G065-V02"
ORIENTATION = 1.0
...
def build_hf_185_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_185_daily(daily_features)
    result = panel.merge(
        daily,
