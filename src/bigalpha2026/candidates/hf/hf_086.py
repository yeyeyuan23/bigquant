r"""HF-086: report-derived candidate, source CICC-024.

Source research ID: CICC-024
Frozen formula: minute_return_skew/minute_return_kurtosis
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CICC-024"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CICC-024"
ORIENTATION = 1.0
...
def build_hf_086_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_086_daily(daily_features)
    result = panel.merge(
        daily,
