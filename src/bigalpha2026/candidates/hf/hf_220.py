r"""HF-220: report-derived candidate, source CJ-G105-V07.

Source research ID: CJ-G105-V07
Frozen formula: mean_21d(high-price amplitude)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CJ-G105-V07"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "CJ-G105-V07"
ORIENTATION = 1.0
...
def build_hf_220_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_220_daily(daily_features)
    result = panel.merge(
        daily,
