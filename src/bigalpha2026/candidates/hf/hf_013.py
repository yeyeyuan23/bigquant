"""HF-013: competition-adapted CICC high-frequency candidate.

Source: CICC, High-Frequency Factor Handbook (2024-01-15), CICC-010.
Semantic class: LATENT_COMPONENT; include in self_library: true.
Data families: HF.
Frozen formula: z-score of the final rolling high-on-low beta within the day.
Economic logic: Closing innovation in the intraday high-low response slope.
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CICC-010"
SOURCE_FIDELITY = "exact"
COMPONENT_COLUMN = "mmt_ols_beta_zscore_last"
ORIENTATION = 1.0
...
def compute_hf_013_daily(daily_features: pd.DataFrame) -> pd.DataFrame:
...
def build_hf_013_factor_from_daily(
    ...
    daily = compute_hf_013_daily(daily_features)
