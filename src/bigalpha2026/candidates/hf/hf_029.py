"""HF-029: competition-adapted CICC high-frequency candidate.

Source: CICC, High-Frequency Factor Handbook (2024-01-15), CICC-073.
Semantic class: LATENT_COMPONENT; include in J baseline: true.
Data families: HF.
Frozen formula: volume before 10:00 divided by full-day volume.
Economic logic: Opening trading concentration.
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "CICC-073"
SOURCE_FIDELITY = "exact"
COMPONENT_COLUMN = "trade_headRatio"
ORIENTATION = 1.0
...
def compute_hf_029_daily(daily_features: pd.DataFrame) -> pd.DataFrame:
...
def build_hf_029_factor_from_daily(
    ...
    daily = compute_hf_029_daily(daily_features)
