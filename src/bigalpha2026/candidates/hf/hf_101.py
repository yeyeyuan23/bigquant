r"""HF-101: report-derived candidate, source HAITONG-0076.

Source research ID: HAITONG-0076
Frozen formula: mean_20d(m5_up_ratio)
...
DATA_FAMILIES = ("HF",)
SOURCE_RESEARCH_ID = "HAITONG-0076"
SOURCE_FIDELITY = "formalized_from_report"
COMPONENT_COLUMN = "HAITONG-0076"
ORIENTATION = 1.0
...
def build_hf_101_factor_from_daily(
    daily_features: pd.DataFrame,
    pool: pd.DataFrame,
) -> pd.DataFrame:
    ...
    daily = compute_hf_101_daily(daily_features)
    result = panel.merge(
        daily,
