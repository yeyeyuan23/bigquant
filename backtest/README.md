...
最新策略预览：[每日 Q10−Q1 的扣费累计收益与回撤](results/20260917_decile_strategy_preview/README.md)。两端各 10%，多空各 100%，每日调仓；扣费后日均单边换手 1.505、年化 13.52%、Sharpe 0.784、累计 21.17%、最大回撤 -14.76%。中证 1000 仅作市场参照。此图先单独预览，正式演示稿现有持仓比较暂未替换。
...
旧 [五分位结果](results/20260917_raw_quintiles/README.md)仅作历史记录，Q5−Q1 为 6.96bp。十分组取两端各 10%，五分位取两端各 20%，二者差异不是模型改善的证据。第 16 页的持仓规则仍为原有 20%/30% 配置。
