...
2026-09-17 新增 [纯多头排名缓冲](results/20260917_long_only_buffer/README.md) 与 [中证 1000 市场参照](results/20260917_csi1000_reference/README.md)。纯多头只保留高分端，前 30% 保留、补足 20% 持股，目标仓位 100%，不卖空、不借入现金。原有三种规则结果保留，演示稿展示每日五分位、多空排名缓冲、纯多头缓冲三种配置；五日平均排名仅作历史研究记录。
...
见 [原始五分位结果与复现说明](results/20260917_raw_quintiles/README.md)。AutoDL 重算的 Q5−Q1 日均差为 6.96bp；不对分数或收益做行业、Barra 风格中性化。分组先于收益标签合并，不模拟隔夜持仓与交易成本。
