...
/root/autodl-tmp/conda-envs/quant/bin/python scripts/screen_fz76_candidate_delta.py \
  ...
  --output reports/archive/legacy_factor_pool/cicc34_delta/development_rank_ic.csv \
  --daily-output reports/archive/legacy_factor_pool/cicc34_delta/development_daily_rank_ic.csv
```
