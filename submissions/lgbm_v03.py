"""Platform-safe rolling LightGBM factor from the refreshed T pool.
...
def main(datasources, start_date, end_date):
    ...
    if train_start_position < 0:
        raise ValueError("not enough pre-start history for LightGBM training")
    ...
    if train.empty or test.empty:
        raise ValueError("empty LightGBM train or prediction sample")
    model = LGBMRegressor(
