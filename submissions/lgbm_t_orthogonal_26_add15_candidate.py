"""Orthogonal T LightGBM with 26 factors; add15, screened15 lambda=1."""
...
def _candidate_factors(selected, financial, factorlib, exposure, daily_features, pool, pd, np):
    import inspect
    from lgbm_t_orthogonal_26_add15_candidate_deps import get_candidate_spec
...
def main(datasources, start_date, end_date):
    ...
    self_columns = ['HF-044', 'HF-057', 'HF-019', 'PV-029', 'HF-001', 'HF-025', 'HF-045', 'PV-034', 'HF-062', 'HF-068', 'HF-034', 'HF-053', 'HF-059', 'HF-067', 'HF-070', 'HF-018', 'HF-017', 'HF-065', 'HF-049', 'HF-071', 'HF-024', 'HF-069', 'PV-031', 'HF-076', 'PV-027', 'HF-046']
