"""I-route pure-increment Elastic Net with 51 factors."""
...
def _candidate_factors(selected, financial, factorlib, exposure, daily_features, pool, pd, np):
    import inspect
    from enet_i_51_candidate_deps import get_candidate_spec
