...
exp=$project_root/experiments/finals_pre/e7_incremental_score
out=$project_root/reports/dependencies/finals_pre/e7_incremental_score
mraw=$project_root/reports/dependencies/finals_pre/e0_holdout_2024_e3/unified_microstructure_full_oos.parquet
