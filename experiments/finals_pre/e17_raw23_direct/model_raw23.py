"""Input-width-controlled copy of the submitted microstructure network."""
...
class ProgressiveConfig:
    ...
    def __post_init__(self) -> None:
        source_input_dim = self.input_dim
        if self.keep_channels:
            if not set(self.keep_channels) <= set(range(source_input_dim)):
