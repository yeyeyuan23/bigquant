"""Pathway-ablation variant of the microstructure expert.

A faithful copy of the frozen MicrostructureNetwork with switches that remove
one pathway at a time (sequence, statistics, cross-section). Feature building,
packing, masking, normalization and the head are byte-identical in behaviour
when every switch is on. The frozen mainline module is never modified.
"""
...
class AblationModel:
    ...
    def __init__(self, **config: Any) -> None:
        ...
        self.network = AblationNetwork(self.config)
