...
echo "[wait] progressive additions $(date --iso-8601=seconds)"
wait_pid_file /tmp/e3_rerun.pid "progressive-addition run"
grep -q '\[all done\]' /tmp/e3_rerun.log

echo "[wait] private bar1m transfer $(date --iso-8601=seconds)"
wait_pid_file /tmp/private1m_pull.pid "private bar1m transfer"
...
rm -rf reports/dependencies/finals_pre/e1_c2c_walkforward/model
rm -f reports/dependencies/finals_pre/e1_c2c_walkforward/a4.json \
  reports/dependencies/finals_pre/e1_c2c_walkforward/block_a4.csv \
  reports/dependencies/finals_pre/e1_c2c_walkforward/daily_rank_ic.csv \
  reports/dependencies/finals_pre/e1_c2c_walkforward/rank_ic_by_block.svg
...
epoch_out=reports/dependencies/finals_pre/e2_c2c_epoch_curve
...
raw_out=reports/dependencies/finals_pre/e5_raw23_direct/c2c_autodl
...
"$PYTHON" experiments/finals_pre/e5_raw23_direct/score_autodl.py \
  --source-dir src \
  --output-dir "$raw_out" \
  --labels experiments/finals_pre/e5_raw23_direct/c2c_labels.parquet \
