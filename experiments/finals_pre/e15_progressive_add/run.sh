...
trainer=$root/experiments/finals_pre/e15_progressive_add/train_progressive.py
data=/root/autodl-tmp/data
store=/root/autodl-tmp/unified_microstructure_store_v2_2019_2024
out=$root/reports/dependencies/finals_pre/e15_progressive_add/c2c
...
"$python_bin" "$root/experiments/finals_pre/e15_progressive_add/score.py"
