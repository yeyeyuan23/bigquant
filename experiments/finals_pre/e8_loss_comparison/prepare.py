...
from experiments.finals_pre.e8_loss_comparison.train import actual_key_hash, checked_update
...
def prepare(data_root, micro_store, exposure, output, device_name="cuda"):
    ...
    from experiments.finals_pre.e8_loss_comparison.score import expected_scoring_keys
